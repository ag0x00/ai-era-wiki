...
verified_against: []
verified_findings: 0
verified_note: "Verify-and-fix on archived item 9 (#169): read against recalibration rule 2, the three deep dives and the core page's Level 3 auditor-evidence line; no .raw document opened. Fixed: the D4-precedent sentence overstated what D4 does, and the item ran as one paragraph where items 8, 24 and 25 split original from resolution."
---
