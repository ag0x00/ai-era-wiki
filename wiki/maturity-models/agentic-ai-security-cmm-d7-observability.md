...
verified_against: []
verified_findings: 0
verified_note: "Every field, span name and absence claim confirmed against live Purview audit-copilot, the CopilotInteraction schema, Agent 365 Copilot Studio observability, and the two Google Gemini log-event pages; no defect found."
---
