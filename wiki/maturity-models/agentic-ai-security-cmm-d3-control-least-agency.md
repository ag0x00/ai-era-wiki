...
verified_against: []
verified_findings: 0
verified_note: "Verify-and-fix for the per-task capability-token rung move (#169), read against recalibration rule 2, D4 lines 93 and 208, and the Tenuo product and company pages; no .raw document opened. Fixed: the L5 assessor-detail list still graded per-task capability tokens, the D4-precedent sentence overstated what D4 lines 93 and 208 do, and the Tenuo staleness note attributed the demo-shaped finding to the product page instead of the company page."
---
