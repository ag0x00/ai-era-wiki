...
verified_against: []
verified_findings: 0
verified_note: "Read against live Microsoft Learn (Copilot prompt defense in depth 2026-09-10, Purview audit-copilot 2026-08-26, admin-center agent-details 2026-08-05) and Google Workspace DLP-for-Gemini 2026-09-16; two fixed: tool-chain analysis is a signal supporting task adherence, not a call-path enforcement point, and the deferral evidence names the Purview DLP gate and all four stages."
---
