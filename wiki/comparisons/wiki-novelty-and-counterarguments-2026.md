...
- Credential Proxy Pattern (nine-tool OSS and commercial convergence, not wiki-discovered)
...
> 10. **CSA ATF promotion gates not fully specified** by CSA itself; CMM [[agentic-ai-security-cmm-d3-control-least-agency|D3]] L4 still depends on org-authored rubric ([[agentic-cmm-vs-standards-validation|validation]] §5).
